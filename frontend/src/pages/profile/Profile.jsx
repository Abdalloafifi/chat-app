...
import { fetchUserProfile, updateUserProfile, uploadProfilePhoto, updateIsUserOk } from "../redux/apicalls/profileapi";
          ...
          <div className="col-lg-8">
            <div className="card mb-4">
              <div className="card-body">
                  ...
                  <div className="col-sm-9">
                    {profile?.Address ? (
                      ...
                      <p className="text-muted mb-0">
                        I will keep it a secret until we get to know each
                        other😁😁
                      </p>
                    )}
                  </div>
                ...
                <div className="row detail-row">
                  <div className="col-sm-3">
                    <p className="mb-0">Find me</p>
                  </div>
                  <div className="col-sm-9">
                    {profile?.isok ? (
                      <p className="text-muted mb-0">Of course I want to😁😁</p>
                    ) : (
                      <p className="text-muted mb-0">
